...
class TestNetworkSecurityGroup < Minitest::Test
  ...
  def test_save_method_response
    @service.stub :create_or_update_network_security_group, @response do
      assert_instance_of Fog::AzureRM::Network::NetworkSecurityGroup, @network_security_group.save
    end
  end
  ...
  def test_update_method_response
    @service.stub :create_or_update_network_security_group, @response do
      assert_instance_of Fog::AzureRM::Network::NetworkSecurityGroup,
  ...
  def test_add_security_rules_method_response
    @service.stub :add_security_rules, @response do
      assert_instance_of Fog::AzureRM::Network::NetworkSecurityGroup, @network_security_group.add_security_rules(ApiStub::Models::Network::NetworkSecurityGroup.security_rules_array)
    end
  end

  def test_remove_security_rule_method_response
    @service.stub :remove_security_rule, @response do
      assert_instance_of Fog::AzureRM::Network::NetworkSecurityGroup, @network_security_group.remove_security_rule('myNsRule')
    end
  end
end
