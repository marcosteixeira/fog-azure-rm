      ...
      class VirtualNetworkGatewayConnection < Fog::Model
        ...
        def self.parse(gateway_connection)
          ...
          unless gateway_connection.virtual_network_gateway1.nil?
            gateway1 = Fog::AzureRM::Network::VirtualNetworkGateway.new
            connection['virtual_network_gateway1'] = gateway1.merge_attributes(Fog::AzureRM::Network::VirtualNetworkGateway.parse(gateway_connection.virtual_network_gateway1))
          end

          unless gateway_connection.virtual_network_gateway2.nil?
            gateway2 = Fog::AzureRM::Network::VirtualNetworkGateway.new
            connection['virtual_network_gateway2'] = gateway2.merge_attributes(Fog::AzureRM::Network::VirtualNetworkGateway.parse(gateway_connection.virtual_network_gateway2))
          end
        ...
        def save
          ...
          merge_attributes(Fog::AzureRM::Network::VirtualNetworkGatewayConnection.parse(gateway_connection))
        end
